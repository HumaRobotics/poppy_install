...
wget -P  /home https://raw.githubusercontent.com/HumaRobotics/poppy_install/poppy-torso/src/poppy_logo
...
#su - poppy -c "curl -L https://raw.githubusercontent.com/HumaRobotics/poppy_install/poppy-torso/src/poppy_install.sh | bash -s poppy-humanoid" >> /home/poppy/install_log
su - poppy -c "curl -L https://raw.githubusercontent.com/HumaRobotics/poppy_install/poppy-torso/src/poppy_install.sh | bash -s poppy-torso" >> /home/poppy/install_log
